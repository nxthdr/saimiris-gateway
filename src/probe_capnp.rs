...
pub mod probe {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,2,4,1,3];
        pub(crate) const TYPE_ID: u64 = 0x9aae_81ab_2292_ba2c;
    }
    ...
    impl ::capnp::introspect::Introspect for Protocol {
        fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&protocol::ARENA, protocol::get_annotation_types)).into() }
    }
    impl ::core::convert::From<Protocol> for ::capnp::dynamic_value::Reader<'_> {
        fn from(e: Protocol) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&protocol::ARENA, protocol::get_annotation_types).into()).into() }
    }
